...
define([
    ...
    "ebg/core/gamegui",
    "ebg/counter",
    g_gamethemeurl + "modules/js/AnimationHandler.js",
    g_gamethemeurl + "modules/js/PlayerHandler.js",
    g_gamethemeurl + "modules/js/HandHandler.js",
    g_gamethemeurl + "modules/js/TableHandler.js",
    g_gamethemeurl + "modules/js/BackgroundHandler.js",
    g_gamethemeurl + "modules/js/ImageLoadHandler.js"
],
function (dojo, declare) {
    return declare("bgagame.odin", ebg.core.gamegui, {
        ...
        onGameUserPreferenceChanged: function(pref_id, pref_value) {
            switch (pref_id) {
                case 100:
                    this.backgroundHandler.walkingCharactersPreferenceChanged(parseInt(pref_value) == 1);
                break;
            }
        },
