 ...
 * particular, you can set here the values of variables elements defined in odin_odin.tpl (elements
...
class view_odin_odin extends game_view
{
    protected function getGameName()
    {
  	...
  	{		
        ...
        */
        ...
        $this->page->begin_block( "odin_odin", "myblock" );
