    ...
    function (dojo, declare) {
        var HandHandler = declare("bgagame.HandHandler", null, {
            ...
            confirmPlayButtonClicked(){
                ...
                if(this.canFinishRound() && dojo.query('.a-card[selected=false]', this.cardsContainer).length > 0)
                    this.gameui.confirmationDialog('You can play all your cards and finish the round!', () => { buttonEvent(); });
                else buttonEvent();
            },
